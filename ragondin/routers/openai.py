        ...
        try:
            async for token in answer_stream:
                ...
                if "logprobs" in token.response_metadata:
                    logprobs.tokens.append(
                        token.response_metadata["logprobs"]["content"][0]["token"]
                    )
                    logprobs.token_logprobs.append(
                        token.response_metadata["logprobs"]["content"][0]["logprob"]
                    )
